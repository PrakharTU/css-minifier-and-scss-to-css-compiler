...
public static void pop()
{
	...
	public static void main( String args[]) throws Exception
	{
			...
			do{
				...
				System.out.println("\n1-Preprocessor");
				System.out.println("2-Minimizer");
				...
				switch(s)
					{
						...
						case "1":
						System.out.print("Enter filepath of file to be preproceesed\t");
						String x =  sc.nextLine();     // Extra nextLine statement that automatically takes /r/n of previous string input
						...
						case "2":
						System.out.print("Enter filepath of file to be preproceesed\t");						
						x =  sc.nextLine();     // Extra nextLine statement that automatically takes /r/n of previous string input
